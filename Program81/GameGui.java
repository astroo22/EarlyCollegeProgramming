...
{
	public double[] ballx = new double[12];
	public double[] bally = new double[12];
	public double[] ballw = new double[12];
	public double[] ballh = new double[12];
    public int framish = 0;
	...
	*/
	...
	{
        String score = "Player:" + playerScore;
